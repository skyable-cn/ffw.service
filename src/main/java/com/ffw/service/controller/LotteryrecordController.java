...
public class LotteryrecordController extends BaseController {
	...
	public List<PageData> listAll(@RequestBody PageData pd) {
		...
		try {
			data = lotteryrecordService.listAll(pd);
		} catch (Exception e) {
	...
	public Page listPage(@RequestBody PageData pd) {
		...
		List<PageData> data = null;
		try {
			data = lotteryrecordService.listPage(page);
		} catch (Exception e) {
			data = new ArrayList<PageData>();
			e.printStackTrace();
		}
	...
	public PageData delete(@RequestBody PageData pd) {
		try {
			lotteryrecordService.delete(pd);
		} catch (Exception e) {
			pd = null;
			e.printStackTrace();
		}
	...
	public PageData find(@RequestBody PageData pd) {
		try {
			pd = lotteryrecordService.findById(pd);
		} catch (Exception e) {
			pd = null;
			e.printStackTrace();
		}
	...
	public PageData findBy(@RequestBody PageData pd) {
		try {
			pd = lotteryrecordService.findBy(pd);
		} catch (Exception e) {
			pd = null;
			e.printStackTrace();
		}
